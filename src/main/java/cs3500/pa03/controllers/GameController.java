...
public class GameController {
  ...
  private final DisplayImp view = new DisplayImp();
  ...
  public void setBoardSize() {
    ...
    userBoard = new GridImp(boardDimensions[0], boardDimensions[1]);
  ...
  public void setupUser() {
    ...
    //PLACE SHIPS
    userBoard.userGridSetup(userBoats);
  }
  /**
  ...
  public void setupAi() {
    ai = new AiPlayer(boardDimensions[0], boardDimensions[1]);
    //GENERATE EMPTY GRID FOR AI
    aiBoard = new GridImp(boardDimensions[0], boardDimensions[1]);
  ...
  public void run() {
    ...
    view.displayBoard(aiBoard.getGrid(), "Opponent Board Data:\n");

    view.displayBoard(userBoard.getGrid(), name + "'s board \n");
  ...
  public void startGame() {
    ...
    while (runGame) {
      ...
      aiBoard.setHit(shotsThatHitComputer);
