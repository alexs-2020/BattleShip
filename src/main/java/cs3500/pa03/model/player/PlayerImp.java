...
public class PlayerImp implements Player {
    ...
    for (Map.Entry<ShipType, Integer> ship : specifications.entrySet()) {
      ...
      while (i < quantity) {
        ...
        if (isOverlap(shipCoords)) {
          ...
          Ship shipPlaced = new Ship(shipType, shipCoords);
  ...
  public List<Coord> takeShots() {
    //ONLY EXCEPTION FOR MODEL VIEW COM
    return view.getUserShots("Please Enter " +  playerShips.size()
        + " Shots: ", playerShips.size());
  }
  /**
